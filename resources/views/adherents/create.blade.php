...
@section('main')
    ...
    {{-- Styles spécifiques à la page "Nouvel adhérent" --}}
    <style>
        .adherent-form-label {
            font-weight: 500;
            color: #e5e7eb;
            ...
            <div class="glass-card p-4 p-md-5">
                <form method="POST" action="{{ route('adherents.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control adherent-form-control" name="prenom" id="prenom"
                            value="{{ old('prenom') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="nom" class="form-label adherent-form-label">Nom</label>
                        <input type="text" class="form-control adherent-form-control" name="nom" id="nom"
                            value="{{ old('nom') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="email" class="form-label adherent-form-label">Email</label>
                        <input type="email" class="form-control adherent-form-control" name="email" id="email"
                            value="{{ old('email') }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="mot_de_passe" class="form-label adherent-form-label">Mot de passe</label>
                        <input type="password" class="form-control adherent-form-control" name="mot_de_passe"
                            id="mot_de_passe" required>
                    </div>
